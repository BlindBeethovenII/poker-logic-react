  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>Add player names and clues to define the playing of players.</li>
        <li>Add sound.</li>
        ...
        <li>User option to indicate which types of clues they prefer when generating a random puzzle.</li>
        <li>Add a warning if a clue is being moved to the other list, and it is still needed.</li>
