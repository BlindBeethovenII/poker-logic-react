...
const HelpPageIntro = () => {
  ...
  return (
    <div>
      ...
      <p>The aim of Poker Logic is to work out the poker hand for each of the four players.</p>
      <p>These four players are currently just named as 1, 2, 3 and 4 and their hands are ordered.</p>
