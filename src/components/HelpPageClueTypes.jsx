...
const HelpPageClueTypes = () => {
  ...
  return (
    <div>
      ...
      <p>A hard part of the puzzle is when you need to combine multiple clues, sometimes combining three or more clues.</p>
      <p>
      ...
      <p>
        Some of the clues use the number value of the card.
        For example, &quot;Hand 1 has all even numbers&quot;.
        For these sorts of clues, an Ace is taken as 14 (hence even), a King 13 (hence odd), a Queen 12 (also even) and a Jack as 11 (also odd). All other cards are face value.
      </p>
