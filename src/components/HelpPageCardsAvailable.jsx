...
const HelpPageCardsAvailable = () => {
  ...
  return (
    <div>
      ...
      <p>As each poker hand consists of 5 cards and as there are 4 players, each Poker Logic puzzle is made up of 20 cards.</p>
      ...
      <p>If you didn&apos;t get that deduction immediately, then you consider the previous help page that talks about hand ordering.</p>
    </div>
  );
};
