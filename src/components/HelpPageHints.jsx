...
const HelpPageHints = () => {
  ...
  return (
    <div>
      ...
      <p>When a hint is showing, you can remove that hint with the Clear Next Hint button, or you can apply the hint by using the Apply Next Hint button.</p>
      <p>
      ...
      <h4>I hope to enhance the hint system so that it highlights the card options involved in the hint. This should make it easier to understand the hint being offered.</h4>
    </div>
  );
};
