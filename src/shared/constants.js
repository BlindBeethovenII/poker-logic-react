...
export const HINT_SAME_N_SUIT_CARDS_IN_SOLUTION_OPTIONS = 'SAME NUMBER OF CARDS OF SUIT LEFT IN SOLUTION OPTIONS';
export const HINT_FOUR_OF_A_KIND_NUMBER = 'FOUR OF A KIND NUMBER';
