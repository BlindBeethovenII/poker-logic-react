...
export const HAND_TYPES_SORTED = [
...
export const HINT_CLUE_CARDS_SAME_NUMBER_TWO_NOT_AVAILABLE = 'CLUE CARDS SAME NUMBER TWO NOT AVAILABLE';
export const HINT_CLUE_CARDS_SAME_NUMBER_THREE_NOT_AVAILABLE = 'CLUE CARDS SAME NUMBER THREE NOT AVAILABLE';
export const HINT_CLUE_CARDS_SAME_NUMBER_FOUR_NOT_AVAILABLE = 'CLUE CARDS SAME NUMBER FOUR NOT AVAILABLE';
...
export const HINT_CLUE_CARDS_SAME_SUIT_TWO_NOT_AVAILABLE = 'CLUE CARDS SAME SUIT TWO NOT AVAILABLE';
export const HINT_CLUE_CARDS_SAME_SUIT_THREE_NOT_AVAILABLE = 'CLUE CARDS SAME SUIT THREE NOT AVAILABLE';
export const HINT_CLUE_CARDS_SAME_SUIT_SIX_NOT_AVAILABLE = 'CLUE CARDS SAME SUIT SIX NOT AVAILABLE';
...
export const CLUE_CARDS_NUMBER_HIGHER_THAN = 'CARDS NUMBER HIGHER THAN';
export const CLUE_CARDS_NUMBER_LOWER_THAN = 'CARDS NUMBER LOWER THAN';
export const CLUE_CARDS_NUMBER_N_HIGHER_THAN = 'CARDS NUMBER N HIGHER THAN';
export const CLUE_CARDS_NUMBER_N_LOWER_THAN = 'CARDS NUMBER N LOWER THAN';
...
export const CLUE_HAND_HAS_NUMBER = 'HAND HAS NUMBER';
export const CLUE_HAND_NOT_NUMBER = 'HAND NOT NUMBER';
export const CLUE_HAND_HAS_SUIT = 'HAND HAS SUIT';
export const CLUE_HAND_NOT_SUIT = 'HAND NOT SUIT';
export const CLUE_HAND_HAS_SUIT_AND_NUMBER = 'HAND HAS SUIT AND NUMBER';
export const CLUE_HAND_NOT_SUIT_AND_NUMBER = 'HAND NOT SUIT AND NUMBER';
...
export const CLUE_ORDERING = {
  ...
  [CLUE_HAND_HAS_SUIT_AND_NUMBER]: 89,
  [CLUE_HAND_NOT_SUIT_AND_NUMBER]: 88,

  [CLUE_SUIT]: 81,
  [CLUE_HAND_HAS_SUIT]: 80,
  [CLUE_NOT_SUIT]: 79,
  [CLUE_HAND_NOT_SUIT]: 78,
  [CLUE_RED_SUIT]: 77,
  [CLUE_RED_SUITS]: 76,
  [CLUE_BLACK_SUIT]: 75,
  [CLUE_BLACK_SUITS]: 74,
  ...
  [CLUE_NUMBER]: 71,
  [CLUE_HAND_HAS_NUMBER]: 70,
  [CLUE_NOT_NUMBER]: 69,
  [CLUE_HAND_NOT_NUMBER]: 68,
  [CLUE_CARD_EVEN]: 67,
  [CLUE_HAND_EVEN]: 66,
  [CLUE_CARD_ODD]: 65,
  [CLUE_HAND_ODD]: 64,
  [CLUE_HAND_LOWEST_NUMBER]: 63,
  [CLUE_HAND_HIGHEST_NUMBER]: 62,
  ...
  [CLUE_CARDS_NUMBER_HIGHER_THAN]: 48,
  [CLUE_CARDS_NUMBER_LOWER_THAN]: 47,
  [CLUE_CARDS_NUMBER_N_HIGHER_THAN]: 46,
  [CLUE_CARDS_NUMBER_N_LOWER_THAN]: 45,
};
...
export const CLUE_ORDERING_REDUCING = {
  ...
  [CLUE_NOT_SUIT]: 40,
  [CLUE_NOT_NUMBER]: 39,
  [CLUE_HAND_NOT_SUIT]: 38,
  [CLUE_HAND_NOT_NUMBER]: 37,

  [CLUE_CARDS_SAME_SUIT]: 30,
  [CLUE_CARDS_NOT_SAME_SUIT]: 29,
  [CLUE_HAND_HAS_SUIT]: 28,

  [CLUE_CARDS_SAME_NUMBER]: 20,
  [CLUE_CARDS_NOT_SAME_NUMBER]: 19,
  [CLUE_HAND_HAS_NUMBER]: 18,
  [CLUE_HAND_LOWEST_NUMBER]: 17,
  [CLUE_HAND_HIGHEST_NUMBER]: 16,

  [CLUE_HAND_HAS_SUIT_AND_NUMBER]: 15,
  [CLUE_HAND_NOT_SUIT_AND_NUMBER]: 14,

  [CLUE_CARDS_NUMBER_HIGHER_THAN]: 13,
  [CLUE_CARDS_NUMBER_LOWER_THAN]: 12,
  [CLUE_CARDS_NUMBER_N_HIGHER_THAN]: 11,
  [CLUE_CARDS_NUMBER_N_LOWER_THAN]: 10,

  [CLUE_HAND_OF_TYPE]: 5,
};

// the basic clues
export const CLUES_BASIC = [
...
// USER_ACTIONS
export const USER_ACTION_APPLY_NEXT_HINT = 'USER_ACTION_APPLY_NEXT_HINT';
export const USER_ACTION_TOGGLE_SHOW_CLUE = 'USER_ACTION_TOGGLE_SHOW_CLUE';
export const USER_ACTION_SET_SUIT_OPTION_ONLY = 'USER_ACTION_SET_SUIT_OPTION_ONLY';
export const USER_ACTION_SET_SUIT_OPTION_ONLY_TO_CARDS_IN_HAND = 'USER_ACTION_SET_SUIT_OPTION_ONLY_TO_CARDS_IN_HAND';
export const USER_ACTION_RESET_SUIT_OPTIONS = 'USER_ACTION_RESET_SUIT_OPTIONS';
export const USER_ACTION_TURN_ON_SUIT_IN_HAND_IF_ON_AND_NOT_PLACED = 'USER_ACTION_TURN_ON_SUIT_IN_HAND_IF_ON_AND_NOT_PLACED';
export const USER_ACTION_TURN_OFF_SUIT_IN_HAND_IF_ON_AND_NOT_PLACED = 'USER_ACTION_TURN_OFF_SUIT_IN_HAND_IF_ON_AND_NOT_PLACED';
export const USER_ACTION_TOGGLE_SUIT_OPTION = 'USER_ACTION_TOGGLE_SUIT_OPTION';
export const USER_ACTION_SET_NUMBER_OPTION_ONLY = 'USER_ACTION_SET_NUMBER_OPTION_ONLY';
export const USER_ACTION_RESET_NUMBER_OPTIONS = 'USER_ACTION_RESET_NUMBER_OPTIONS';
export const USER_ACTION_TOGGLE_NUMBER_OPTION = 'USER_ACTION_TOGGLE_NUMBER_OPTION';
export const USER_ACTION_TURN_ON_NUMBER_IN_HAND_IF_ON_AND_NOT_PLACED = 'USER_ACTION_TURN_ON_NUMBER_IN_HAND_IF_ON_AND_NOT_PLACED';
export const USER_ACTION_TURN_OFF_NUMBER_IN_HAND_IF_ON_AND_NOT_PLACED = 'USER_ACTION_TURN_OFF_NUMBER_IN_HAND_IF_ON_AND_NOT_PLACED';
